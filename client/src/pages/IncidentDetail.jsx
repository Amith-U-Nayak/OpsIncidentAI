        ...
        {activeTab === 'Post-Mortem' && (
          <div className="space-y-6">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-slate-400 text-sm font-medium">Final Post-Mortem Report</h3>
              {postMortem && (
                <span className="text-xs text-indigo-400 bg-indigo-500/10 px-2 py-1 rounded">Generated by AI</span>
              )}
            </div>
